...
import { mockMonthlyData, mockCompanies, mockShops } from "@/lib/mockData";
  ...
  return (
    ...
    >
      <Card className="shadow-soft">
        <CardHeader>
          <CardTitle>Monthly Purchase vs Sales Trend</CardTitle>
        </CardHeader>
        <CardContent>
...
export function CompanyPurchasesChart() {
  const data = mockCompanies.map(c => ({
    name: c.name.split(' ')[0],
  ...
  return (
    ...
    >
      <Card className="shadow-soft">
        <CardHeader>
          <CardTitle>Company-wise Purchases</CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
